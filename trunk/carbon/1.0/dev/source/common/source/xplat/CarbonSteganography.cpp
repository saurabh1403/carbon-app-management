...
namespace carbonStegano
{
	...
	bool retrieveDataFromBmp(const std::string &inBmpFilePath, const std::string &outData){ return true;}
	bool hideDataInBmp(const std::string &inData, const std::string &inBmpFilePath, const std::string &outBmpFilePath){ return true;}
